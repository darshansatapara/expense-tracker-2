...
//   // PDF Export with Improved Structure
...
//         pdf.setFontSize(18);
//         pdf.setTextColor(0, 102, 204);
//         pdf.text("Expense Tracker Report", margin, 10);
//         pdf.setFontSize(10);
//         pdf.setTextColor(100);
//         pdf.text(`Generated on ${new Date().toLocaleDateString()}`, margin, 20);
//         pdf.setFontSize(10);
...
//             </div>
//           </div>
//           <p className="text-sm text-gray-500 mt-2">Generated on April 10, 2025</p>
//         </div>
//       </header>
...
//         {/* Currency Usage Chart and Table */}
