...
const PieChart = ({ labels = [], data = [], title = "", total = "", isSmallScreen = false }) => {
  ...
  const chartHeight = isSmallScreen 
    ? hasManyCategoriesOnSmallScreen ? "140px" : "160px" 
    : "200px";
  ...
  return (
    <div className="w-full">
      ...
      {total && (
        <p className={`text-center mt-1 ${isSmallScreen ? "text-xs" : "text-sm"} text-gray-600 font-medium`}>
          Total: {total}
        </p>
      )}
    </div>
