...
export default function PersonalDetails() {
  ...
  const handleSaveField = async (field) => {
    try {
      const updatedData = {
        [field]: userProfile[field], // Only send the changed field
      };
      await updateUserProfile(userId, updatedData);
      message.success(`${field === "profilePic" ? "Profile picture" : field} updated successfully`);
  ...
  // // Options for the profession select field
